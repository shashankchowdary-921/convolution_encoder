...
def render_header():
    st.markdown(
        ...
        '<div style="display:inline-block;background:#EEF2FF;color:#4F46E5;font-size:0.75rem;font-weight:600;letter-spacing:0.08em;padding:0.25rem 0.75rem;border-radius:999px;margin-bottom:1rem;text-transform:uppercase;">Digital Communications · Course Project</div>'
